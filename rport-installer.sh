...
#
FINGERPRINT="60:51:21:74:fc:5f:1b:27:42:c1:90:3f:f5:ad:64:92"
CONNECT_URL="http://remoteclients.wobot.ai:80"
CLIENT_ID="openeye"
PASSWORD="gfuyfsuggudsf"
...
download_and_extract() {
    ...
    if is_available curl; then
        curl -LSs "https://woconnect.blob.core.windows.net/rport/rport_0.9.12_linux_x86_64.tar.gz?sp=r&st=2023-11-21T10:34:44Z&se=2026-02-09T18:34:44Z&spr=https&sv=2022-11-02&sr=b&sig=itt7TO8%2FOfqQ1xCUBMPuzhAjcSHX0S1hx76HhaIRUgU%3D" -o rport.tar.gz
    elif is_available wget; then
        wget -q "https://woconnect.blob.core.windows.net/rport/rport_0.9.12_linux_x86_64.tar.gz?sp=r&st=2023-11-21T10:34:44Z&se=2026-02-09T18:34:44Z&spr=https&sv=2022-11-02&sr=b&sig=itt7TO8%2FOfqQ1xCUBMPuzhAjcSHX0S1hx76HhaIRUgU%3D" -O rport.tar.gz
    else
